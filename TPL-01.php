<?php
// TPL-01 — Fortunata (template asal: sample arsip lokal) — kontrak data/data.json
...
$DEFAULT_CONTENT = '<p>Selamat datang di situs kami. Di sini Anda dapat menemukan berbagai informasi, panduan, dan layanan yang dirancang untuk mempermudah kebutuhan Anda. Jelajahi menu di atas untuk mulai.</p><h2>Tentang Kami</h2><p>Situs ini menyajikan konten yang informatif dan mudah dipahami. Setiap bagian disusun agar Anda dapat menemukan apa yang dibutuhkan dengan cepat.</p><h2>Cara Memulai</h2><p>Cukup tekan tombol daftar dan isi formulir sederhana. Setelah akun aktif, Anda langsung dapat menggunakan seluruh fitur yang tersedia.</p><h2>Pertanyaan Umum</h2><h3>Bagaimana cara mendaftar?</h3><p>Klik tombol daftar, isi identitas dasar, dan ikuti instruksi yang muncul. Prosesnya hanya membutuhkan beberapa menit.</p><h3>Apakah bisa diakses dari ponsel?</h3><p>Tentu. Tampilan situs responsif dan dapat diakses dari perangkat apa pun melalui browser.</p>'
